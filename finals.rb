...
students.each do |student|
  ...
  count = count + 1
  suspicious = false
  #next if count < 14 #|| count > 285 # if we need to start at a specific position in the list of students
  ...
  p.workbook.add_worksheet do |sheet|
    ...
    quiz_list.each do |q|
      ...
      if (q['title'] == "Final Exam A") || (q['title'] == "Final Exam B")
        ...
        break if DateTime.parse(q['due_at'].to_s) > end_time && q['title'] == "Final Exam B" # or if escape is true
...
File.open("/Users/lkangas/Documents/Tests/July2018/"+filenom+".txt", 'w+') do |f|
  f.puts(pumpkin)
end
puts skipped
puts "Pumpkin"
