...
students.each do |student|
  ...
  count = count + 1
  suspicious = false
#next if count < 140 #|| count > 285 # if we need to start at a specific position in the list of students
  ...
  p.workbook.add_worksheet do |sheet|
    ...
    quiz_list.each do |q|
      ...
      if (q['title'].include? "Test A") || (q['title'].include? "Test B")
        ...
        p.serialize('/Users/lkangas/Documents/Tests/July2018/'+filenom+'.xlsx')
        j = j + 1
      else
        # Print to console
